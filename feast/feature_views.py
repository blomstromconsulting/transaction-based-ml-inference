...
customer_transaction_stats_view = FeatureView(
    ...
    schema=[
        ...
        Field(name="current_merchant_visit_count_30d", dtype=Int64),
        Field(name="current_merchant_visit_share_30d", dtype=Float64),
        Field(name="current_merchant_rank_30d", dtype=Int64),
        Field(name="is_current_merchant_top_visited_30d", dtype=Int64),
        Field(name="days_since_first_seen_current_merchant", dtype=Float64),
        Field(name="days_since_last_seen_current_merchant", dtype=Float64),
        Field(name="customer_distinct_merchants_30d", dtype=Int64),
        Field(name="is_new_merchant_for_customer", dtype=Int64),
        Field(name="top_visited_merchant_id_30d", dtype=String),
    ],
    online=True,
