...
public class ReceiveTransactionEventService implements ReceiveTransactionEventUseCase {
    ...
    public FraudDecision receive(TransactionEvent event) {
        ...
        featureMaterializationPort.materializeCustomerFeatures(CustomerFeatureRow.from(normalized, stats));
        featureMaterializationPort.materializeMerchantFeatures(MerchantFeatureRow.from(normalized));
